	...
	window.eqx = {}, window.eqx.money = {
		config: {
			...
			resources: [{
				...
				url: CLIENT_CDN + "Public/css/images/money/moneybg.png",
				type: "image"
			}, {
				url: CLIENT_CDN + "Public/css/images/money/moremoney.png",
				type: "image"
			}, {
				url: CLIENT_CDN + "Public/css/images/money/flymoney.png",
				type: "image"
			}, {
				url: CLIENT_CDN + "Public/css/images/money/float.png",
				type: "image"
			}, {
				url: CLIENT_CDN + "Public/css/images/money/float2.png",
				type: "image"
			}, {
				url: CLIENT_CDN + "Public/css/images/money/float3.png",
				type: "image"
			}]
		}
	}, window.eqx.snowFly = {
...
function(a, b) {
	...
	function appendActivityPage(a, b) {
		a.obj.property.activityPageId && (activityPagePromise = $.ajax({
			type: "GET",
			url: PREFIX_S1_URL + "?c=scene&a=getlastpagebg&id=" + a.obj.property.activityPageId,
			xhrFields: {
				withCredentials: !0
			},
			crossDomain: !0,
	...
	function eqFreepage(a, b, c) {
		...
		if (ad = 1, a.obj.property.lastPageId) customLastPage = !0, $.ajax({
			type: "GET",
			url: PREFIX_S1_URL + "?c=scene&a=getlastpagebg&id=" + a.obj.property.lastPageId,
			xhrFields: {
				withCredentials: !0
			},
			crossDomain: !0,
	...
	function eqCustomBottomLabel(a, b) {
		ad = 2, $.ajax({
			type: "GET",
			url: PREFIX_S1_URL + "index.php?c=scene&a=getlastpagebg&id=" + a.obj.property.bottomLabel.id,
			xhrFields: {
				withCredentials: !0
			},
			crossDomain: !0,
			success: function(c) {
				...
				for (d.length; e < d.length; e++) {
					var f = d[e];
					if (f.sceneId = a.obj.id, f.pageId = b[b.length - 1].id, a.obj.property.bottomLabel.name && a.obj.property.bottomLabel.url && "http://" != a.obj.property.bottomLabel.url) 2 == f.type && f.content.indexOf("微上宝科技公司") > 0 && (f.content = f.content.replace(/EQXIU.COM科技公司/, '<a href="' + PREFIX_S1_URL + "index.php?c=scene&a=link&id=" + a.obj.id + "&amp;url=" + encodeURIComponent(a.obj.property.bottomLabel.url) + '" target=_blank>' + a.obj.property.bottomLabel.name + "</a>"));
					else if (a.obj.property.bottomLabel.name) 2 == f.type && f.content.indexOf("微上宝科技公司") > 0 && (f.content = f.content.replace(/微上宝科技公司/, a.obj.property.bottomLabel.name));
	...
	if ((param.indexOf("preview=preview") > 0 || window.preview || isNewPreviewLocation) && (preview = !0), param.indexOf("branchid=") > 0 && (branchid = param.substring(param.indexOf("branchid=") + 9)), param.indexOf("mobileview=mobileview") > 0 && (mobileview = !0), !(mobilecheck() || tabletCheck() && window == window.top)) {
		var getBg = function() {
				/*$.ajax({
					type: "GET",
					url: PREFIX_S2_URL + "?c=ad&a=preview",
					xhrFields: {
						withCredentials: !0
					},
					crossDomain: !0
				...
				$("body").css("backgroundImage", "url(http://sy.pinzs.com/Uploads/ad/2015-05-29/5567bb76ebe63.jpeg)");
			},
			addElmentsForPc = function(a) {
				...
				c.href = CLIENT_CDN + "common/css/pcviewer.css", c.rel = "stylesheet", b.appendChild(c), window != window.top ? ($("body").css("background-image", "none"), window.location.href.indexOf("hidePhone") > 0 && ($(".top").hide(), $(".bottom").hide(), $(".phone_menubar").hide(), $(".scene_title_baner").attr("style", "display:none !important"))) : (getBg(), $.getScript(CLIENT_CDN + "common/js/qrcode.js", function() {
					$.getScript(CLIENT_CDN + "common/js/jquery.qrcode.js", function() {
						...
						b = "http://" + getDomain(window.location.href), $("#codeImg").qrcode({

							render: "canvas",
							width: 200,
							height: 200,
							//text: b + "/v-" + a + "?eqrcode=1"?c=scene&a=view&id=
							text: b + "/v-" + a + "?eqrcode=1"
							//text: b + "?c=scene&a=view&id=" + a + "?eqrcode=1"
						})
					})
